...
const ChatContainer = () => {
  ...
  // Loading messages using useeffect
  useEffect(() => {    
            ...
            <div key={message._id}
              ...
              <div className='chat-image avatar'>
                <div className='size-10 rounded-full border' >
                  <img src={message.senderId === authUser._id ? authUser.profilePic || "/avatar.png" : selectedUser.profilePic || "avatar.png"} alt="ProfileImg" />
                </div>
              </div>
              ...
              <div className='chat-bubble flex flex-col'>
                {message.image && (
                  <img 
                    src={message.image}
                    alt='Attachment'
                    className='sm:max-w[200px] rounded-md mb-2 size-20'
                 />
                )}
